...
<footer class="footer">
	<div class="container footer__inner">
		<div class="footer__brand"><?php echo esc_html( epigenome_opt( 'domain_name' ) ); ?></div>
		...
		<div class="footer__legal">&copy; <?php echo esc_html( gmdate( 'Y' ) ); ?> · <?php echo esc_html( epigenome_opt( 'broker_name' ) ); ?> · <?php esc_html_e( 'Serious inquiries only', 'epigenome' ); ?></div>
	</div>
</footer>
