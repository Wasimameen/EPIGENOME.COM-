...
function epigenome_customize_register( $wp_customize ) {
	...
	$fields = array(
		...
		'contact_email'    => array( 'Contact email (top bar + offers are sent here)', 'email', get_option( 'admin_email' ) ),
		'contact_phone'    => array( 'Contact phone (shown in the top bar)', 'text', '+1 (480) 758-2520' ),
		'contact_location' => array( 'Top bar — location / transfer note (right)', 'text', 'Worldwide · remote transfer' ),
		'contact_status'   => array( 'Top bar — availability note (right)', 'text', 'Available — replies same day' ),
