...
export class VeoClient {
     ...
     */
    async processImageInput(image, mimeType) {
     ...
     */
    async generateFromText(prompt, config, options) {
        try {
     ...
     * @returns Metadata for the generated video and optionally the video data
     */
    async generateFromImage(image, prompt, config, options, mimeType) {
        try {
     ...
     */
    async saveVideoBuffer(videoBuffer, prompt, config, id = uuidv4()) {
        try {
